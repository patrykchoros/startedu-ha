...
class RepositoryStructureTests(unittest.TestCase):
    ...
    def test_installation_docs_and_release_checklist_present(self) -> None:
        ...
        self.assertIn("StartEdu user guide", readme)
        ...
        self.assertIn("What You Will See", user_guide)
        self.assertIn("Cancelling Meals", user_guide)
        self.assertIn("Dashboard Example", user_guide)
        self.assertIn("Automation Examples", user_guide)
        self.assertIn("button.<child>_cancel_today_meals", user_guide)
        self.assertIn("Avoid blind automatic cancellation", user_guide)
        self.assertIn("[User Guide](User-Guide)", wiki_home)
        ...
        self.assertTrue(Path("docs/wiki/User-Guide.md").exists())
